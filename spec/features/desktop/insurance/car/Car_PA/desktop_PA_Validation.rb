...
feature 'Car PA Test Suite', :skip_qat, :uae do
  ...
  scenario 'TC-PA-002 - To verify PA policy page details' do
    ...
    Agency_Years.size.times do |i|
      ...
      page.find(:xpath,"//a[@class='underline-link']").click
      sleep 5
      ...
      sleep 60
      visit current_path
      @app.broker_car_insurance_policy_details.verify_pa_policy_status("ISSUED")
      expect(page).to have_xpath("//tr[@class='odd docRow']/td[text()='Policy']")
      @app.broker_car_insurance_policy_details.pa_verification("Salama","#{reverse_date}","#{merchant_ref}")
