...
class BrokerTravelInsurancePolicyDetails < BasePage
  ...
  element :policy_status, :xpath, "//*[contains(text(),'Policy Status:')]/following-sibling::strong/span"
  ...
  def upload_policy
    ...
    fields_array = {"Policy" => "pdf", "OFFLINE_QUOTE" => "pdf"}
  ...
  def issue_policy(policy_number, policy_price)
